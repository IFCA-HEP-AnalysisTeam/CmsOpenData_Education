...
class Analyzer(object):
	...
	def __init__(self):
		...
		self.g_efficiency=ROOT.TH1F('g_efficiency','efficiency',10,0,11)
	...
	#####################################################################
		...
		self.ghistos = ROOT.TFile("datafiles/goodHistos.root", "RECREATE")
		...
		self.ghistos.Close()
		print "Selected histograms saved in datafiles/goodHistos.root file"
